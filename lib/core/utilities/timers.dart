// ignore_for_file: non_constant_identifier_names, prefer_asserts_with_message
...
abstract class Timers {
  ...
  //   ){
  //
  //     final String? _hours = formatIntWithinDigits(num: time.hour, digits: 2);
  //     final String? _minutes = formatIntWithinDigits(num: time.minute, digits: 2);
  //     final String? _seconds = formatIntWithinDigits(num: time.second, digits: 2);
  //
